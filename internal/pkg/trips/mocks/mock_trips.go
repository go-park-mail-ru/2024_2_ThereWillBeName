...
//
//	mockgen -source=internal/pkg/trips/interfaces.go -destination=internal/pkg/trips/mocks/mock_trips.go -package=repo
//
...
func (mr *MockTripsUsecaseMockRecorder) AddPhotosToTrip(ctx, tripID, photos any) *gomock.Call {
...
func (mr *MockTripsUsecaseMockRecorder) DeletePhotoFromTrip(ctx, tripID, photoPath any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockTripsRepoMockRecorder) AddPhotoToTrip(ctx, tripID, photoPath any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// DeletePhotoFromTrip indicates an expected call of DeletePhotoFromTrip.
func (mr *MockTripsRepoMockRecorder) DeletePhotoFromTrip(ctx, tripID, photoPath any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
