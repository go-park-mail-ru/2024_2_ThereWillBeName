...
//
//	mockgen -source=internal/pkg/auth/interfaces.go -destination=internal/pkg/auth/mocks/mock.go -package=auth
//
...
func (mr *MockAuthUsecaseMockRecorder) SignUp(ctx, user any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAuthRepoMockRecorder) DeleteUser(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAuthRepoMockRecorder) GetUsers(ctx, count, offset any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAuthRepoMockRecorder) UpdateUser(ctx, user any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
