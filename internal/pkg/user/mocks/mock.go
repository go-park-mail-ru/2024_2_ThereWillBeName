...
// func (m *MockUserUsecase) UploadAvatar(ctx context.Context, userID uint, avatarFile multipart.File, header *multipart.FileHeader) (string, error) {
// 	m.ctrl.T.Helper()
// 	ret := m.ctrl.Call(m, "UploadAvatar", ctx, userID, avatarFile, header)
// 	ret0, _ := ret[0].(string)
// 	ret1, _ := ret[1].(error)
// 	return ret0, ret1
// }
...
// func (mr *MockUserUsecaseMockRecorder) UploadAvatar(ctx, userID, avatarFile, header interface{}) *gomock.Call {
// 	mr.mock.ctrl.T.Helper()
// 	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UploadAvatar", reflect.TypeOf((*MockUserUsecase)(nil).UploadAvatar), ctx, userID, avatarFile, header)
// }
