...
func (m *MockPlaceRepo) SearchPlaces(ctx context.Context, name string, category, city, limit, offset int) ([]models.GetPlace, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SearchPlaces", ctx, name, category, city, limit, offset)
	ret0, _ := ret[0].([]models.GetPlace)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockPlaceRepoMockRecorder) SearchPlaces(ctx, name, category, city, limit, offset interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SearchPlaces", reflect.TypeOf((*MockPlaceRepo)(nil).SearchPlaces), ctx, name, category, city, limit, offset)
}
...
// SearchPlaces mocks base method.
func (m *MockPlaceUsecase) SearchPlaces(ctx context.Context, name string, category, city, limit, offset int) ([]models.GetPlace, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SearchPlaces", ctx, name, category, city, limit, offset)
	ret0, _ := ret[0].([]models.GetPlace)
	ret1, _ := ret[1].(error)
...
// SearchPlaces indicates an expected call of SearchPlaces.
func (mr *MockPlaceUsecaseMockRecorder) SearchPlaces(ctx, name, category, city, limit, offset interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SearchPlaces", reflect.TypeOf((*MockPlaceUsecase)(nil).SearchPlaces), ctx, name, category, city, limit, offset)
}
